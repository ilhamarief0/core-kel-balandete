            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <x-common.page-title
                    ...
                    :breadcrumbs="[
                        ...
                        ['label' => 'Media Kelurahan'],
                        ['label' => 'Informasi Kelurahan']
                    ]"
                />
            </div>
        </div>
            ...
            <x-common.card>
                <x-slot name="header">
                    <div class="card-title">
                        <x-ui.search-input id="searchInput" placeholder="Search informasi kelurahan" />
                    </div>
                    <div class="card-toolbar">
                          <a href="{{ route('backend.informasiKelurahan.create') }}" id="add-news" class="btn btn-primary">
                ...
                ]" show-checkbox="true" class="kt_table_informasiKelurahan">
...
@push('scripts')
    <script src="{{ asset('assets/backend/js/custom/apps/informasiKelurahan/table.js') }}"></script>
    <script src="{{ asset('assets/backend/js/custom/apps/informasiKelurahan/delete.js') }}"></script>
@endpush
