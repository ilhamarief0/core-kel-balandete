        ...
        <x-common.app-content>
            <x-common.card>
                ...
                <x-table.dynamic-table :headers="[
                    ['label' => 'Name', 'class' => 'min-w-125px'],
                    ['label' => 'Email', 'class' => 'min-w-125px'],
                    ['label' => 'Contact', 'class' => 'min-w-125px'],
                    ['label' => 'Created At', 'class' => 'min-w-125px'],
                    ['label' => 'Actions', 'class' => 'text-end min-w-100px']
                ]" show-checkbox="true" class="kt_table_contactus">
...
@push('scripts')
    <script src="{{ asset('assets/backend/js/custom/apps/contactus/table.js') }}"></script>
