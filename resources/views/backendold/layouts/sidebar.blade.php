<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6 d-flex align-items-center" id="kt_app_sidebar_logo">
        <a href="#" class="d-flex align-items-center text-decoration-none">
            <img alt="Logo" src="{{ asset('assets/frontend/images/logo2.png') }}" class="h-30px h-lg-40px app-sidebar-logo-default" />
        </a>
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu"
                    ...
                    <div class="menu-item pt-5">
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">Media Kelurahan</span>
                        </div>
                    </div>
                      <div class="menu-item">
                        <a class="menu-link {{ Route::is('backend.informasiKelurahan.*') ? 'active' : '' }}"
                            href="{{ route('backend.informasiKelurahan.index') }}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-element-11 fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                      ...
                      <div class="menu-item">
                        <a class="menu-link {{ Route::is('backend.news.*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title">Berita Kelurahan</span>
                        </a>
                    </div>
