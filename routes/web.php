...
Route::post('uploadckEditorImage', [ckEditorUploadController::class, 'uploadCkeditorImage'])->name('uploadCkeditorImage');
...
Route::middleware('auth')->prefix('backend/')->name('backend.')->group(function(){
  ...
  Route::get('websiteSetting/getData', [WebsiteSettingController::class, 'getData'])->name('websiteSetting.getData');
  Route::post('websiteSetting/update', [WebsiteSettingController::class, 'update'])->name('websiteSetting.update');
  Route::get('websiteSetting', [WebsiteSettingController::class, 'index'])->name('websiteSetting.index');
