...
var KTUsersAddUser = (function () {
    const modalElement = document.getElementById("kt_modal_add_team");
    const form = modalElement.querySelector("#kt_modal_add_team_form");
    ...
    const showSuccessNotification = function (message, clientName = '') {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $(".kt_table_team").DataTable().ajax.reload(); // Refresh DataTable
            }
        });
    };
    ...
    if (submitButton) {
        submitButton.addEventListener("click", function (event) {
            ...
            let clientName = $("#kt_modal_add_team_form input[name='name']").val(); // Ambil dari input name
