...
var KTNewsAdd = (function () {
    const form = document.getElementById("kt_modal_add_service_form");
    const submitButton = form.querySelector('[data-kt-service-add-action="submit"]');
            ...
            success: function (response) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = response.redirect_url || '/backend/service';
                    }
                });
            },
            error: function (xhr) {
