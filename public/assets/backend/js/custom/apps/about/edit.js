...
var KTNewsEdit = (function () {
    const form = document.getElementById("kt_modal_edit_about_form");
    const submitButton = form.querySelector('[data-kt-about-edit-action="submit"]');
            ...
            success: function (response) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = response.redirect_url || '/backend/about';
                    }
                });
            },
            error: function (xhr) {
